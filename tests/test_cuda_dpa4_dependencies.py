...
from scripts.verify_wheel import CUDA_FORBIDDEN_LIBRARY_NAMES, CUDA_RUNTIME_LIBRARY_NAMES
...
def test_dpa4_cuda_does_not_require_blas_runtime() -> None:
    ...
    assert CUDA_RUNTIME_LIBRARY_NAMES == ("libcudart",)
    assert CUDA_FORBIDDEN_LIBRARY_NAMES == ("libcublas", "libcublasLt")
