...
def xp_uniform(like: Array, size: int, low: float = 0.0, high: float = 1.0) -> Array:
    ...
    other backends use :mod:`mdescriptor.dpa4._official_core.utils.random`. Draws are therefore not
    ...
    from mdescriptor.dpa4._official_core.utils import random as dp_random
