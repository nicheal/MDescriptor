...
def build_neighbor_graph(
    ...
    *,
    ...
    (:func:`~mdescriptor.dpa4._official_core.dpmodel.utils.nlist.extend_coord_with_ghosts`) to materialise all
    ...
    canonicalize
        ...
        ``with_csr=True``.
    pair_excl
        Optional :class:`~mdescriptor.dpa4._official_core.dpmodel.utils.neighbor_graph.graph.PairExcludeMask`
    ...
    """
    from mdescriptor.dpa4._official_core.dpmodel.utils.nlist import (
        extend_coord_with_ghosts,
    )
    from mdescriptor.dpa4._official_core.dpmodel.utils.region import (
        normalize_coord,
    )
