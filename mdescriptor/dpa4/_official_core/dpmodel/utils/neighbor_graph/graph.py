...
def compact_nodes(
    ...
    from mdescriptor.dpa4._official_core.dpmodel.utils.neighbor_graph.segment import (
        segment_sum,
    )
    ...
    if graph.destination_row_ptr is not None:
        from mdescriptor.dpa4._official_core.dpmodel.utils.neighbor_graph.csr import (
            attach_edge_csr,
        )
