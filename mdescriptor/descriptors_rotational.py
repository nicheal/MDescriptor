...
class EadCalculator(_AtomCalculator):
    name = "EAD"
...
class So3Calculator(_AtomCalculator):
    name = "SO3"
...
class So4Calculator(_AtomCalculator):
    name = "SO4"
...
class SnapCalculator(So4Calculator):
    name = "SNAP"

    def __init__(self, weights: dict[Any, float] | None = None, **kwargs: Any):
...
class LbispectrumCalculator(SnapCalculator):
    name = "LBispectrum"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(lmax=max(0, self.twojmax // 2), weights=weights, **kwargs)
...
__all__ = ["EadCalculator", "So3Calculator", "So4Calculator", "SnapCalculator", "LbispectrumCalculator"]
