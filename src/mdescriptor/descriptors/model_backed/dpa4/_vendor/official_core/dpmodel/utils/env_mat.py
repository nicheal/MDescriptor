...
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.safe_gradient import (
...
class EnvMat(NativeOP):
    ...
    def call(
        ...
        nlist
            ...
            builder (``mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.nlist.build_neighbor_list``) fills
