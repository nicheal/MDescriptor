...
Two distinct groups (see the upstream graph-layout design discussion, decision
#17), kept
...
def build_neighbor_graph(
    ...
    *,
    ...
    (:func:`~mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.nlist.extend_coord_with_ghosts`) to materialise all
    ...
    canonicalize
        ...
        ``with_csr=True``.
    pair_excl
        Optional :class:`~mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.neighbor_graph.graph.PairExcludeMask`
    ...
    """
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.nlist import (
        extend_coord_with_ghosts,
    )
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.region import (
        normalize_coord,
    )
