...
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.finetune import (
...
def get_econf_tebd(
    ...
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.econf_embd import (
        ECONF_DIM,
    )
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.econf_embd import (
        normalized_electronic_configuration_embedding as electronic_configuration_embedding,
    )
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.econf_embd import type_map as periodic_table
