...
length policy (GraphLayout). See the upstream graph-layout design discussion.
...
def compact_nodes(
    ...
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.neighbor_graph.segment import (
        segment_sum,
    )
    ...
    if graph.destination_row_ptr is not None:
        from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.neighbor_graph.csr import (
            attach_edge_csr,
        )
