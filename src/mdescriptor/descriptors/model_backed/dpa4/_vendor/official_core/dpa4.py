...
``upstream.pt.model.descriptor.sezm``.
"""
...
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel import (
    NativeOP,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.array_api import (
    xp_asarray_nodetach,
    xp_scatter_sum,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.common import (
    PRECISION_DICT,
    get_xp_precision,
    to_numpy_array,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils import (
    EnvMat,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.exclude_mask import (
    PairExcludeMask,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.neighbor_graph import (
    apply_pair_exclusion,
    graph_from_dense_quartet,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.seed import (
    child_seed,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.update_sel import (
    UpdateSel,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.charge_state import (
    validate_charge_state,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.version import (
...
if TYPE_CHECKING:
    ...
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.data_system import (
        DeepmdDataSystem,
    )
    from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.utils.path import (
        DPPath,
    )
...
def _graph_from_padded_nlist(
    ...
    see ``upstream.pt.model.descriptor.sezm_nn.edge_cache.build_edge_cache``):
