...
``upstream.pt.model.descriptor.sezm_nn.projection``.
"""
...
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.lebedev import (
    LEBEDEV_PRECISION_TO_NPOINTS,
    load_lebedev_rule,
)
from mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.utils.spherical_harmonics import (
