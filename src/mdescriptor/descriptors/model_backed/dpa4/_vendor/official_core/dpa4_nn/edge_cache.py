...
``upstream.pt.model.descriptor.sezm_nn.edge_cache``.
"""
...
def _edge_cache_from_arrays(
    *,
    ...
    gamma
        ...
        (:func:`~mdescriptor.descriptors.model_backed.dpa4._vendor.official_core.dpmodel.array_api.xp_uniform`) uniformly in
