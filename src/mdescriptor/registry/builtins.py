...
_BUILTIN_SPECS = (
    ...
    DescriptorSpec("MBTR", _MANY_BODY + "MBTR", AssetPolicy.NONE, "cpp", "structure", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("LMBTR", _MANY_BODY + "LMBTR", AssetPolicy.NONE, "cpp", "atom", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("ValleOganov", _MANY_BODY + "ValleOganov", AssetPolicy.NONE, "cpp", "structure", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("AtomicComposition", _LOCAL + "AtomicComposition", AssetPolicy.NONE, "cpp", "structure", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("NeighborList", _LOCAL + "NeighborList", AssetPolicy.NONE, "cpp", "pair", capabilities=_CPP_THREAD_CAPABILITIES),
    ...
    DescriptorSpec("EAD", _ROTATIONAL + "EAD", AssetPolicy.NONE, "cpp", "atom", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("SO3", _ROTATIONAL + "SO3", AssetPolicy.NONE, "cpp", "atom", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("SO4", _ROTATIONAL + "SO4", AssetPolicy.NONE, "cpp", "atom", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("SNAP", _ROTATIONAL + "SNAP", AssetPolicy.NONE, "cpp", "atom", capabilities=_CPP_THREAD_CAPABILITIES),
    DescriptorSpec("LBispectrum", _ROTATIONAL + "LBispectrum", AssetPolicy.NONE, "cpp", "atom", capabilities=_CPP_THREAD_CAPABILITIES),
    ...
    DescriptorSpec("DPA4C", _MODEL + "dpa4c.descriptor:DPA4C", AssetPolicy.REQUIRED, "numpy", "atom", capabilities=_COMMON_CAPABILITIES | {"model", "spin", "charge_spin"}),
)
