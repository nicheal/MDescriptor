...
from mdescriptor._vendor.dpa4._official_core.dpmodel.utils.lebedev import (
    LEBEDEV_PRECISION_TO_NPOINTS,
    load_lebedev_rule,
)
from mdescriptor._vendor.dpa4._official_core.dpmodel.utils.spherical_harmonics import (
