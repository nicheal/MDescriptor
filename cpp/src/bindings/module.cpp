...
PYBIND11_MODULE(_native, module) {
    ...
    py::class_<SoapTurboCalculator>(module, "SoapTurboCalculator")
        ...
        .def_property_readonly("alpha_max", &SoapTurboCalculator::alpha_max)
        .def_property_readonly("channel_offsets", &SoapTurboCalculator::channel_offsets)
        .def_property_readonly("central_allowed", &SoapTurboCalculator::central_allowed)
        .def_property_readonly("basis_offsets", &SoapTurboCalculator::basis_offsets)
        .def_property_readonly("basis_transforms", &SoapTurboCalculator::basis_transforms)
        .def_property_readonly("gaussian_columns", &SoapTurboCalculator::gaussian_columns)
        .def_property_readonly("compression_offsets", &SoapTurboCalculator::compression_offsets)
        .def_property_readonly("compression_sources", &SoapTurboCalculator::compression_sources)
    ...
    py::class_<MtpCalculator>(module, "MtpCalculator")
        ...
        .def_property_readonly("official_species_count", &MtpCalculator::official_species_count)
        .def_property_readonly("official_scaling", &MtpCalculator::official_scaling)
        .def_property_readonly("official_alpha_moments_count", &MtpCalculator::official_alpha_moments_count)
        .def_property_readonly("official_alpha_index_basic", &MtpCalculator::official_alpha_index_basic)
        .def_property_readonly("official_alpha_index_times", &MtpCalculator::official_alpha_index_times)
        .def_property_readonly("official_radial_coefficients", &MtpCalculator::official_radial_coefficients)
        .def_property_readonly("official_model_species", &MtpCalculator::official_model_species)
        .def_property_readonly("official_model_parameters", &MtpCalculator::official_model_parameters)
        .def_property_readonly("official_radial_scaling", &MtpCalculator::official_radial_scaling)
        .def_property_readonly("official_radial_recursive", &MtpCalculator::official_radial_recursive)
        .def_property_readonly("official_radial_zeroth", &MtpCalculator::official_radial_zeroth)
        .def_property_readonly("official_radial_exp_ratio", &MtpCalculator::official_radial_exp_ratio)
        .def_property_readonly("official_radial_maxdist_sq", &MtpCalculator::official_radial_maxdist_sq)
        .def_property_readonly("official_radial_maxdist_sq_minus_eps", &MtpCalculator::official_radial_maxdist_sq_minus_eps)
        .def_property_readonly("official_radial_vdw_params", &MtpCalculator::official_radial_vdw_params)
        .def_property_readonly("official_radial_kind", &MtpCalculator::official_radial_kind)
        .def_property_readonly("official_moments", &MtpCalculator::official_moments)
        .def_property_readonly("official_eval_kinds", &MtpCalculator::official_eval_kinds)
        .def_property_readonly("official_eval_linear_ids", &MtpCalculator::official_eval_linear_ids)
        .def_property_readonly("official_eval_linear_coefficients", &MtpCalculator::official_eval_linear_coefficients)
        .def_property_readonly("official_eval_product_offsets", &MtpCalculator::official_eval_product_offsets)
        .def_property_readonly("official_eval_product_left", &MtpCalculator::official_eval_product_left)
    ...
    py::class_<AceCalculator>(module, "AceCalculator")
        ...
        .def_property_readonly("base_species", &AceCalculator::base_species)
        .def_property_readonly("base_radial", &AceCalculator::base_radial)
        .def_property_readonly("base_angular", &AceCalculator::base_angular)
        .def_property_readonly("base_magnetic", &AceCalculator::base_magnetic)
        .def_property_readonly("radial_a", &AceCalculator::radial_a)
        .def_property_readonly("radial_b", &AceCalculator::radial_b)
        .def_property_readonly("radial_c", &AceCalculator::radial_c)
        .def_property_readonly("radial_t_left", &AceCalculator::radial_t_left)
        .def_property_readonly("radial_t_right", &AceCalculator::radial_t_right)
        .def_property_readonly("radial_p_left", &AceCalculator::radial_p_left)
        .def_property_readonly("radial_p_right", &AceCalculator::radial_p_right)
        .def_property_readonly("center_feature_offsets", &AceCalculator::center_feature_offsets)
        .def_property_readonly("feature_term_offsets", &AceCalculator::feature_term_offsets)
    ...
    py::class_<MtpOptions>(module, "MtpOptions")
        ...
        .def_readwrite("model_data", &MtpOptions::model_data)
    ...
    py::class_<NepOptions>(module, "NepOptions")
        ...
        .def_readwrite("model_data", &NepOptions::model_data)
